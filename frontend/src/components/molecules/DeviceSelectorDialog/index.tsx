...
import { Dialog, DialogActions, DialogContent, DialogTitle, Button, FormControl, InputLabel, MenuItem, Select, TextField, Box } from "@mui/material";
...
export default function DeviceSelectorDialog({ open, onClose, onSelectDevice }: DeviceSelectorDialogProps) {
    ...
    return (
      <Dialog open={open} onClose={onClose}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleConfirm} color="primary" variant="contained" disabled={!selectedDeviceId}>
            Selecionar
          </Button>
        </DialogActions>
      </Dialog>
